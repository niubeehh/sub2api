export default {
    accounts: {
      ...
      dataExportIncludeProxies: 'Include linked proxies (without proxy passwords)',
      dataImport: 'Import',
      ...
      dataExportConfirmMessage: 'The exported data contains sensitive account and proxy information (proxy passwords are NOT included). Store it securely.',
